...
- corr_mean_persistent_valleys_vs_rul_coverage: corr=-0.25729058105856606, 95% CI=[-0.49729017575105333, -0.01848688236138207]
...
## Figures
- `outputs\publication_full_rtx4050\topology_rul_figs\topology_vs_rul_bins.png`
- `outputs\publication_full_rtx4050\topology_rul_figs\surface_h1_vs_rul_coverage.png`
- `outputs\publication_full_rtx4050\topology_rul_figs\gamma_vs_pred_mae.png`
