...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument(
        "--gate-summary-json",
        type=str,
        default="outputs/publication_full_rtx4050/publication_gate_summary.json",
        help="Publication gate JSON used to freeze the artifact snapshot date in the manuscript.",
    )
    p.add_argument(
    ...
    p.add_argument(
        ...
        type=str,
        default="outputs/publication_full_rtx4050/policy_sharpness_frontier.png",
...
def _write_values_tex(
    ...
    snapshot_date = _snapshot_date(gate_summary or {})
    lines = [
        "% Auto-generated by scripts/build_submission_paper_assets.py",
        f"\\newcommand{{\\ArtifactSnapshotDate}}{{{snapshot_date}}}",
